...
import 'schema/form1_record.dart';
...
export 'schema/form1_record.dart';
...
Future<int> queryHistoricoRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      HistoricoRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );
...
/// Functions to query Form1Records (as a Stream and as a Future).
Future<int> queryForm1RecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      Form1Record.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<Form1Record>> queryForm1Record({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      Form1Record.collection(parent),
      Form1Record.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<Form1Record>> queryForm1RecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
